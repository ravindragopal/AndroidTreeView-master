 ...
 */
public class SelectableTreeFragment extends Fragment implements SelectableItemHolder.SelectableInterface{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        SelectableHeaderHolder selectableHeaderHolder=new SelectableHeaderHolder(getActivity());
    ...
    private void fillFolder(TreeNode folder) {
        TreeNode file1 = new TreeNode("File1").setViewHolder(new SelectableItemHolder(getActivity(),tView));
        TreeNode file2 = new TreeNode("File2").setViewHolder(new SelectableItemHolder(getActivity(),tView));
        TreeNode file3 = new TreeNode("File3").setViewHolder(new SelectableItemHolder(getActivity(),tView));
